...
# --- Configuration ---
model_name = "Helsinki-NLP/opus-mt-zh-en"  # Chinese -> English
...
batch_inputs = tokenizer(chinese_texts, return_tensors="pt", padding=True, truncation=True)
...
for i, (zh, en) in enumerate(zip(chinese_texts, batch_results), 1):
    print(f"    English: {en}")
