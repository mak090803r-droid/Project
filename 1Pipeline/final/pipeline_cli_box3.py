"""
pipeline_cli_box3.py  (Final Demo — CLI / Keyboard + Advanced Quality Feedback v3)
==================================================================================
Based on pipeline_cli_box.py, with software adjustments for the Logitech C525:
  ...
  gemini told to remove GaussianBlur at line 154 to comment it

Usage:
    python pipeline_cli_box3.py
"""
...
# ══════════════════════════════════════════════════════════════════════════════
PREPROCESS_CONFIG = {
    "upscale_factor":   1,   # Scaled up to 1.5x so 720p is read like 1080p by PaddleOCR
    "clahe_clip":       2,
    "clahe_grid":       8,
    "gamma":            0.7,
    "sharpen":          False, # Keep False to avoid harsh Laplacian noise amplification
