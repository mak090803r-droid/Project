"""
pipeline_cli.py  (Final Demo — CLI / Keyboard Version)
=======================================================
...
Demo Flow:
  ...
  2. CLI: Choose language + book mode (on PC terminal)
  3. Load models → TTS "Models loaded"
  4. Wait for Pi to connect
  5. TTS "Press S to start translating"
  6. Capture loop: S captures latest frame → OCR → Translate → Speak
  7. Q to quit
