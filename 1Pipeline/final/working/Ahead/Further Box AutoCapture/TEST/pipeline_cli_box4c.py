"""
pipeline_cli_box4c.py  (Box4b + faster guidance and stable text geometry)
==================================================================================
Based exactly on pipeline_cli_box3d3.py. OCR recognition, translation,
SymSpell, TTS playback, controls, and the socket protocol are preserved.
...
Usage:
    C:/Users/ali/Desktop/FYDP/fydp/Scripts/python.exe pipeline_cli_box4c.py
"""
...
def pre_capture_quality_loop(frame_holder, ocr_engine, tts_module,
    ...
    print("\n[QUALITY] Box4c text-envelope capture guidance active …")
                ...
                while not key_queue.empty():
                    ...
                    if key == 's':
                        print(
                            ...
                            "all Box4c safety gates were bypassed.")
                        _safe_debug_call(
                            debug_recorder, "record_event",
...
def process_and_speak(frame, run_count, language, book_mode,
    ...
    try:
        ...
        with open(log_path, "a", encoding="utf-8") as f_log:
            ...
            f_log.write("CODE VERSION: pipeline_cli_box4c.py\n")
