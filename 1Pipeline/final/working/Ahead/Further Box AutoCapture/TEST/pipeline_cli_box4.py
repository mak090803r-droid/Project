"""
pipeline_cli_box4.py  (Box3d3 + head-mounted capture guidance)
==================================================================================
...
Usage:
    C:/Users/ali/Desktop/FYDP/fydp/Scripts/python.exe pipeline_cli_box4.py
"""
...
def process_and_speak(frame, run_count, language, book_mode,
    ...
    try:
        ...
        with open(log_path, "a", encoding="utf-8") as f_log:
            ...
            f_log.write("CODE VERSION: pipeline_cli_box3d3.py\n")
